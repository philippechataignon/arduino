/*
 * utility functions for AVR processors (old stle)
 * Most of these functions are redundant and can also be found in AVR C library
 * e.g. _BV() instead of BIT()
 * These functions are compatible with ICC compiler but can be used with GCC
 * they are deprecated and GCC library functions should be used for new applications
 */
